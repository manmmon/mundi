 ...
 *
 */
public class Code28672VerifyAction extends VerifyAbstractAction {

	public Code28672VerifyAction() {
	...
	protected String[] getStock(HttpClient paramHttpClient, String paramString) throws Exception {
		...
		String parameterJson = "[{\"paramName\":\"ownerid\",\"paramValue\":\"1\",\"Operation\":\"In\",\"Logic\":\"AND\"}]";
	...
	protected String[] getSale(HttpClient paramHttpClient, String paramString) throws Exception {
		...
		long nd = System.currentTimeMillis();
		String parameterJson = "[{\"paramName\":\"ownerid\",\"paramValue\":\"1\",\"Operation\":\"In\","
