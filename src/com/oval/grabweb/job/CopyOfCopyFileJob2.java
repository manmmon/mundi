...
public class CopyOfCopyFileJob2 implements Job {
	
	private static Logger logger = Logger.getLogger(CopyOfCopyFileJob2.class);
	public static String standardFileDir="";
	public static String testFileDir="";
	public static String orgcode="";
	private static CopyOfCopyFileJob2 instance;
...
// 				System.out.println("testFileDir:"+testFileDir);
	...
	private static void doCopy(String rootSrc, String rootDest, String rootTestDest) {
		try {
 		  ...
 		  if (instance == null) {
 				instance = new CopyOfCopyFileJob2();
 				instance.getFileDir();
 		   }
...
// copyDir(srcSubDir,destDir,destTestDir,orgcode);
	...
	public static void main(String[] args) throws IOException {
		CopyOfCopyFileJob2.doCopy("d:/xjpfile","d:/dest","d:/dest");		
	}
}